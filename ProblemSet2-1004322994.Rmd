...
\subsection*{Table 4: Logistic regression model table controlling for education}
...
\subsection*{Table 3: Percent of missing values for variables used.}
```{r, warning=FALSE,message=FALSE}
