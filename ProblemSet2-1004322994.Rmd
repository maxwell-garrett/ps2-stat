...
Our logistic regression model is specified in figure 2 with its coefficients. Below, we will outline the meaning of the coefficients for each variable's terms. We will begin with the visible minority coefficient as this is of interest.
